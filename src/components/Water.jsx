...
import { Color, FloatType, MeshDepthMaterial, NoBlending, RGBADepthPacking } from 'three';
...
export const Water = ({ ...props }) => {
  ...
  const { waterColor, waterOpacity, speed, noiseType, foam, foamTop, repeat, maxDepth } =
    useControls({
